...
import { UserIcon, EnvelopeIcon, LockClosedIcon, PhoneIcon } from "react-native-heroicons/outline";
...
const BuyerSignUp = () => {
  ...
  const handleSignUp = () => {
    ...
    axios.post(`${BaseUrl}Auth/register?signUpType=BuyerSignUp`, signUpType)
      .then(response => {
